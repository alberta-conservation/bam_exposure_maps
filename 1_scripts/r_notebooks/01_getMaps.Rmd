...
Next, load the BAM species table and the v5 and ABMI bird species lists. Then filter for speices that are present in both lists. 
```{r, echo=FALSE, warning=FALSE, message=FALSE}
...
Finally, download the maps for BCR 6.1 and send to the 'bam_v5_maps' folder. 
